    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("manager", models.ForeignKey(blank=True, limit_choices_to={"role__in": ["manager", "admin"]}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="team_members", to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("status", models.CharField(choices=[("present", "Present"), ("leave", "Leave")], default="present", max_length=20)),
                ...
                ("distance_from_office_meters", models.FloatField(blank=True, null=True)),
